...
<script>
var nipd; //SEMENTARA pakai nipd/NIM LOG nya
var location_of_LOG;
...
function download(){
	...
	a.download = nipd+"-<?php echo $nama_file_LOG; ?>";
...
var getData= function(arrayJSON,counter){
	...
	nipd=arrayJSON[counter]['nipd'];
	location_of_LOG="../LOG/NilaiTransfer/"+nipd+"-<?php echo $nama_file_LOG; ?>";
