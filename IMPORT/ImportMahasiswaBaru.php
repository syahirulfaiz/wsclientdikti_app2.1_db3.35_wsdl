...
<script>
var mulai_smt; //SEMENTARA Sebelum ada identifier Global untuk id_smt dan kode_prodi agar bisa fleksibel LOG nya
var kode_prodi;
var location_of_LOG;
...
function download(){
	...
	a.download = mulai_smt+"-"+kode_prodi+"-<?php echo $nama_file_LOG; ?>";
...
var getData= function(arrayJSON,counter){
	...
	mulai_smt=arrayJSON[counter]['mulai_smt'];
	kode_prodi=arrayJSON[counter]['kode_prodi'];
	location_of_LOG="../LOG/"+mulai_smt+"/"+kode_prodi+"/"+mulai_smt+"-"+kode_prodi+"-<?php echo $nama_file_LOG; ?>";
